...
- Windows versions: Windows 10 version 1903 or higher recommended.
  ...
  - Windows 10 version 2004 has been partially tested with guinget, though I intend on making a video showing how to use guinget which will use Windows 10 version 2004.

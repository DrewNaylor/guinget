...
SHA-256 sum for "guinget.exe" in the 32-bit archive:
FB549A86AE201AB03FE78641FCF0DD469D8286C424BAC7F1B2D3B397F45BDB2E

SHA-256 sum for "guinget.exe" in the 64-bit archive:
21A5A07408C20C120B54005AED730803E47B82E4203B90849816AE21A36E7D31
...
- A 64-bit build of guinget is now available. This build is experimental and may be discontinued if it turns out to not work as well as the 32-bit one. It may not be possible to upgrade from the 32-bit version to the 64-bit version, so you may need to manually uninstall the old one and reconfigure your settings in the 64-bit one.

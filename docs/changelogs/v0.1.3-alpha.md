...
- More experimental options have been added, and you can use them by clicking in the lower-left corner of the `About` window then opening `Tools>Options...>Experimental`.

...
LicenseFile=C:\Users\drewn\My Applications\guinget\v0.1-alpha\LICENSE.txt
InfoBeforeFile=C:\Users\drewn\My Applications\guinget\v0.1-alpha\README for guinget.txt
InfoAfterFile=C:\Users\drewn\My Applications\guinget\v0.1-alpha\v0.1-alpha_changelog_from-v0.1-prealpha2.txt
OutputDir=C:\Users\drewn\My Applications\guinget\v0.1-alpha\
OutputBaseFilename=guinget_v0.1-alpha
Compression=lzma
...
[Files]
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\guinget.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\README for guinget.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\source-code.zip"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\guinget.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\v0.1-alpha_changelog_from-v0.1-prealpha2.txt"; DestDir: "{app}"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "..\..\..\..\My Applications\guinget\v0.1-alpha\LICENSE-YamlDotNet.txt"; DestDir: "{app}"; Flags: ignoreversion

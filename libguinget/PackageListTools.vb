                                            ...
                                            Await Task.Run(Sub()
                                                               ...
                                                               Catch ex As System.IO.DirectoryNotFoundException
                                                                   If LongFilePathMessageShown = False Then
                                                                       MessageBox.Show("The file path for this manifest is too long. You'll need to turn LongPathsEnabled on in the Windows Registry manually for now, or use the EnableLongPathsEnabled.reg file that shipped with guinget. You can turn it back off with DisableLongPathsEnabled.reg. These files must be opened from an elevated (Administrator) process, such as Command Prompt or PowerShell. A future version will make this easier. After doing either, you need to restart your computer to ensure the changes take effect for everything. We won't tell you again during this extraction for any more files we run into that are too long." & vbCrLf &
                                                                                       vbCrLf &

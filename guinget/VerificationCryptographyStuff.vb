...
Public Class VerificationCryptographyStuff
    ...
    Friend Shared Function GetUnciphered(InputString As String) As String
        ...
        InputString = InputString.Remove(InputString.IndexOf("e"), 1).Insert(InputString.IndexOf("e", 5), "r")
        InputString = InputString.Remove(InputString.IndexOf("e"), 2).Insert(InputString.IndexOf("e", 12), "d")

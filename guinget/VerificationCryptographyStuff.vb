...
Public Class VerificationCryptographyStuff
    ...
    Friend Shared Function GetUnciphered(InputString As String) As String
        ...
        InputString = InputString.Remove(InputString.IndexOf("3"), 1).Insert(InputString.IndexOf("3"), "o")
        InputString = InputString.Remove(InputString.IndexOf("3"), 2).Insert(InputString.IndexOf("3"), "e")
        InputString = InputString.Remove(InputString.IndexOf("6"), 1).Insert(InputString.IndexOf("6"), "u")
    End Function
